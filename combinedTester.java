...
public class combinedTester {
	...
	public static void main(String[] args) {		
		...
		if (false) {
			...
			AVLTree.IAVLNode virtualLeaf1 = tree1.new AVLNode(-1, null, null);
			AVLTree.IAVLNode node1 = tree1.new AVLNode(209, "", virtualLeaf1);
	...
	public static void joiner() {
		...
		for (int i = 0; i < 100; i++) {
			...
			if (i%2 == 1) {
				...
				AVLTree.IAVLNode virtualLeaf = tree.new AVLNode(-1, null, null);
				AVLTree.IAVLNode node = tree.new AVLNode(300*i - 1, Integer.toString(i), virtualLeaf);
